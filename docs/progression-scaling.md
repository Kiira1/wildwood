...
- Weapons, chests, and helmets add 5%–40% to earned damage, health, and regeneration, up to 72% at +10. Each upgrade adds 8% of the original bonus. Gear percentages are independent of campaign stat scaling and never enter saved base stats. Equipment never grants attack speed.
...
## Release 0.742 correction

Campaign enemy stats, rewards, boss stats, and loot rules are restored exactly to 0.739. The 0.740 seven-day/1qd rebalance is reverted. Percentage equipment and the Endless slowdown are retained. Endless pays 10% of the normal authored rewards starting at map 1, while endurance grows with the sixth power of depth. No player-save migration or reset is part of this correction.
