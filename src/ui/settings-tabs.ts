const SETTINGS_GROUPS = [
  { id: "game", label: "Game", selectors: ["#screenShakeToggle", "#damageFlashToggle", "#toolbarHapticsToggle", "#attackRangeToggle", "#chatToggle", "#fullscreenToggle", "#keepScreenOnToggle", "#lowPerformanceToggle", "#fpsToggle", "#latencyToggle"] },
