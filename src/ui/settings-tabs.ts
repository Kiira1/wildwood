...
const SETTINGS_GROUPS = [
  { id: "game", label: "Game", selectors: ["#screenShakeToggle", "#damageFlashToggle", "#toolbarHapticsToggle", "#selfProfileTapToggle", "#attackRangeToggle", "#chatToggle", "#gameTickerToggle", "#fullscreenToggle", "#keepScreenOnToggle", "#lowPerformanceToggle", "#fpsToggle", "#latencyToggle"] },
