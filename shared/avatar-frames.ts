...
export type PatreonStatus = { configured: boolean; linked: boolean; tier: AvatarFrame; frame: AvatarFrame; validUntilMs: number };
export const AVATAR_FRAME_ASSET = "assets/wildstat/avatar-frames/supporter.png";
